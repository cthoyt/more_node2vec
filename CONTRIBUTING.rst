...
----------------------------------
1. Check that you have the latest version of :code:`more_node2vec`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/cthoyt/more-node2vec/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/cthoyt/more-node2vec
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/more-node2vec
...
If you spend a while working on your changes, further commits may be made to the main :code:`more_node2vec`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/cthoyt/more-node2vec
